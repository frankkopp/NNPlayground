...
/**
 * Handwritten digits image classification on MNIST dataset (99% accuracy). This example will
 * download 15 Mb of data on the first run. Supervised learning best modeled by CNN.
 *
 * @author hanlon
 * @author agibsonccc
 * @author fvaleri
        ...
        new NeuralNetConfiguration.Builder()
            ...
            .layer(
                ...
                new OutputLayer.Builder(LossFunctions.LossFunction.NEGATIVELOGLIKELIHOOD)
                    ...
                    .build())
            .setInputType(
                InputType.convolutionalFlat(28, 28, 1)) // InputType.convolutional for normal image
            .backprop(true)
            .pretrain(false)
            .build();
